...
--
-- Produced once by Better Auth's own schema generator for better-auth@1.7.2
-- (see migrations/README.md). Treat it as frozen: schema changes on a
-- Better Auth upgrade go in a new numbered migration, not by editing this
-- file.
