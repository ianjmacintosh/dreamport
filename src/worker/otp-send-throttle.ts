...
/**
 * Fallback for `SEND_OTP_DAILY_CAP` when unset / non-numeric / ≤ 0, on an
 * environment that actually sends through Resend. A mock environment with no
 * explicit cap is uncapped instead — see {@link resolveDailyCap}.
 */
